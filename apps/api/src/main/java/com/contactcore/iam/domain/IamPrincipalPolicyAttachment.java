...
@Entity
@Table(name = "iam_principal_policy_attachment")
public class IamPrincipalPolicyAttachment extends BaseEntity {
    ...
    protected IamPrincipalPolicyAttachment() {}

    public IamPrincipalPolicyAttachment(String tenantId, IamPrincipalRef principal, IamManagedPolicy policy) {
